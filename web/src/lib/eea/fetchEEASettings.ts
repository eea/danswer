...
export async function fetchEEASettings() {
    ...
    const footerHtml =
        eea_config?.footer?.footer_html ||
        '<a class="py-4" href="https://Danswer.ai" target="_blank"><div class="flex"><div class="h-[32px] w-[30px]"><Image src="/logo.png" alt="Logo" width="1419" height="1520" /></div><h3 class="flex text-l text-strong my-auto">&nbsp;Powered by Danswer.ai</h3></div></a>';
    return {
