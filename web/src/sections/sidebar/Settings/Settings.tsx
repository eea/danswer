    ...
    <>
      <PopoverMenu>
        {[
          ...
          <LineItem icon={SvgFileText} href="/pages/disclaimer">
            Disclaimer
          </LineItem>,
          <LineItem icon={SvgFileText} href="/pages/privacy">
            Privacy Architecture
          </LineItem>,
          <LineItem icon={SvgFileText} href="/pages/privacy-statement">
            Privacy Statement
          </LineItem>,
          <LineItem icon={SvgFileText} href="/pages/whats-new">
            What&apos;s new
          </LineItem>,
          null,
          showLogout && (
